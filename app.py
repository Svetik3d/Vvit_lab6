...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_second.addWidget(self.b_umn)
        ...
        self.b_delite = QPushButton("CE", self)
        self.hbox_result.addWidget(self.b_delite)
        ...
        self.b_delite.clicked.connect(self._delite)
    ...
    def _button(self, param):
        ...
        if (line + param).count(".")>1:
            print((line + param), (line + param).count("."))
            self._delite()
            print("error")
            self.input.setText("")
    ...
    def _operation(self, op):
        ...
        if self.num_1 == "": self.num_1 = 0.0
        else: self.num_1 = float(self.num_1)
        self.op = op
        self.input.setText("")
